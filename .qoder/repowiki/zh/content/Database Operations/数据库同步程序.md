...
Service->>Service : 解析患者ID
Service->>Template : 加载SQL模板
Template-->>Service : 返回模板
Service->>Oracle : 查询检验结果
Oracle-->>Service : 返回检验数据
Service->>Service : 数据验证和转换
Service->>Repository : 检查重复记录
Repository-->>Service : 返回检查结果
Service->>Repository : 保存新记录
...
**图表来源**
- [LabSyncService.java:1-632](file://med_ai_assistant_1.0_bs_backend/src/main/java/com/example/medaiassistant/hospital/service/LabSyncService.java#L1-L632)
- [LabSyncController.java:1-349](file://med_ai_assistant_1.0_bs_backend/src/main/java/com/example/medaiassistant/controller/LabSyncController.java#L1-L349)
