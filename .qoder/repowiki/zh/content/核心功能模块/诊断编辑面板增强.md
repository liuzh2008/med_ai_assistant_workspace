...
- [PromptTemplateEditDialog.vue:1-466](file://med_ai_assistant_1.0_bs_vue/src/components/ai/PromptTemplateEditDialog.vue#L1-L466)
...
| 端点 | 方法 | 功能 | 请求体 | 响应 |
|------|------|------|--------|------|
| `/api/ai/deptSpecial` | POST | 创建科室特殊内容 | CreateDeptSpecialDTO | PromptTemplateDeptSpecial |
| `/api/ai/deptSpecial` | GET | 按模板查询科室特殊内容 | promptType, promptName | List<PromptTemplateDeptSpecial> |
| `/api/ai/deptSpecial/department` | GET | 按科室查询科室特殊内容 | department | List<PromptTemplateDeptSpecial> |
| `/api/ai/deptSpecial` | PUT | 更新科室特殊内容 | UpdateDeptSpecialDTO | PromptTemplateDeptSpecial |
