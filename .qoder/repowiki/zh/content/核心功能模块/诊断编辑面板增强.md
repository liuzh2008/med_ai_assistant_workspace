...
**更新** 系统现已增强诊断管理功能，提供更完整的诊断编辑体验，包括双击编辑、删除、设为主要诊断等核心功能。
...
- **PatientInfo**: 诊断信息展示和编辑的核心组件，现已增强完整的诊断管理功能
...
**更新** PatientInfo组件现已完全重构，提供完整的诊断管理和编辑功能：
...
2. **主诊断优先排序**: 数据库层面的排序优化
3. **增强的前端组件**: 更丰富的交互和状态管理
4. **改进的用户体验**: 键盘快捷键、确认对话框等人性化设计
