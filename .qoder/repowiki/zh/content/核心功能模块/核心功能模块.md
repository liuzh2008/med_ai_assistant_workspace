...
## 更新摘要
**所做更改**
- 新增治疗计划连续性功能：实现诊疗计划表的结构化存储与连续性迭代，支持AI生成的Markdown诊疗计划表解析为结构化项目数据
- 诊断编辑面板与卡片组件增强：提供更直观的诊断管理界面，支持诊断列表与详细信息的可视化展示
- AI结果渲染优化：诊疗计划表重要程度色标替换逻辑更新，支持"关键/重要/一般"三种级别
- 系统更新功能完善：BuildDownloadController实现响应式流式下载与Docker卷挂载部署
